...
men5:	lpm t, z+
	...
	ldi xl, 30
men17:	call GetButtons		;wait until button relesaed or time out
	cpi t, 0
	breq men7
	dec xl
	brne men17

men7:	call GetButtons		;wait until button pressed
	cpi t, 0x00
	breq men7
...
men19:	call GetButtons		;wait until buttons relesed
	cpi t, 0
	brne men19	
